                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8">
                    <div className="hidden md:block">
                        <div className="flex items-center justify-between w-full gap-x-12">
                            <h1
                                className={`text-lg md:text-2xl  font-semibold mb-4 sm:mb-0 cursor-pointer  ${!isLeaderboardOpen && 'text-[#facc14]'
                                    }`}
                    ...
                    <div className="block md:hidden">
                        <div className="flex items-center justify-between w-full gap-x-44">
                            <h1
                                className={`text-lg md:text-2xl  font-semibold mb-4 sm:mb-0 cursor-pointer  ${!isLeaderboardOpen && 'text-[#facc14]'
                                    }`}
                                onClick={() => setIsLeaderboardOpen(false)}
